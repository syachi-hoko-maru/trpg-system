...
const wordList: { [key: string]: string } = {
  ...
  "グラスランナー": "グラスランナーはSW2.5でキャラクターとして使える種族の1つ。",
  "メリア": "メリアはSW2.5でキャラクターとして使える種族の1つ。",
  "ティエンス": "ティエンスはSW2.5でキャラクターとして使える種族の1つ。",
  "レプラカーン": "レプラカーンはSW2.5でキャラクターとして使える種族の1つ。",
  "シャドウ": "シャドウはSW2.5でキャラクターとして使える種族の1つ。",
  "ソレイユ": "ソレイユはSW2.5でキャラクターとして使える種族の1つ。",
  "アルヴ": "アルヴはSW2.5でキャラクターとして使える種族の1つ。",
  "ウィークリング": "ウィークリングはSW2.5でキャラクターとして使える種族の1つ。",
}
