...
const samplewords = ["ソード・ワールド2.5", "初心者向け", "アーケインレリック", "SW2.5 サプリメント", "SW2.5 新刊", "SW2.5 種族", "SW2.5 技能", "オンセ 素材", "自己紹介シート", "おすすめシナリオ", "ウォフトルーバの研究所跡", "エンシェントブルー", "デモンズライン", "スプリガン", "アビスボーン", "フロウライト", "アルケリンガ"]
