...
もし「初GMに挑戦！」ということであれば、拙作だと「ウォフト=ルーバの研究所跡」や「ふきのとうを採りに」の方がおすすめです。
&button_/scenario

&2 あらすじ
キングスフォールのいくつかの冒険者ギルド支部へ、有力な貴族から秘密の依頼がくる。
...
-- プレイヤー1人の場合
--- 成長回数7回
--- 経験点+8,500点（合計11,500点）
--- 所持金10,000G
--- 所持名誉点115点
--- 所持アビスシャード2個
-- プレイヤー2人の場合
--- 4〜5レベル（成長回数5回・『ルールブックIII』p.72参照）
- 想定時間
-- オンライン・ボイスセッションの場合
--- 2〜3時間
-- オンライン・テキストセッションの場合
