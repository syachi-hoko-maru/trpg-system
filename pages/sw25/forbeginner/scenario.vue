...
&br
「いいからおすすめのシナリオを教えて！」って方は &link_#おすすめシナリオ一覧,こちらをクリック してください。
&br
GMをする際、ほとんどの場合、 &em_シナリオを準備する必要 があります。
...
&br
「シナリオを探す」といっても、いろいろな方法があり、またggっても出てこないことがあります。
このページでは &em_僕の知っているソード・ワールド2.5のシナリオの探し方を網羅 し、それぞれのメリット・デメリットなどを説明しています。
ぜひ参考にしてください！
&br
なお、ここに書かれている方法はソード・ワールド2.5だけではなく、 &em_クトゥルフ神話TRPGなどの他のTRPGでもシナリオを探す際に参考になるはず です。
TRPGのシナリオを探す方法で困っている方はぜひご一読ください。
...
&button_/sw25/forbeginner/suppliment/1/#サプリメントの分類 サプリメントの分類についてはこちら
&br
このうち、初心者GMにおすすめなのは &em_ツアーサプリに掲載のシナリオを使う ことです。
...
ソード・ワールド2.5のシナリオはファンによってそれなりの数が公開されており、 &em_無料で遊べるものも多数 あります。

&3 拙作「ウォフト=ルーバの研究所跡」について
宣伝になってしまいますが、拙作の &em_「ウォフト=ルーバの研究所跡」 は僕自身がソード・ワールド2.5の初心者・未経験者向けに布教するために作ったシナリオです。
&em_初心者GMでも回せるよう、GM向けのアドバイスなども記載 しております。
&br
...
&link_/sw25/tool/material,しゃちほこ丸が作った素材はこちら で紹介しています。
...
&br
検索リンクが作れなかったので、以下のボタンから開いた上で、 &em_ワードに「2.5」と入力し、システムカテゴリを「ソード・ワールド」として、「キーワード検索」 をしてください。
...
const myScenario: s = {
  ...
  explain: [
    "最後にもう一度、拙作を紹介させていただきます。よければこちらも遊んだり、参考にしたりしてください。",
  ],
  link: "/scenario?"
}
