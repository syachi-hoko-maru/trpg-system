...
const andml1 = `
&1 このページについて
このページでは管理人のしゃちほこ丸が作った、 &em_ソード・ワールド2.5（SW2.5）などのTRPGで役立つ素材 を &em_全て無料で公開 しています。
&br
ココフォリアでの使用を想定して作っていますが、その他のツールを使用したオンラインセッション（オンセ）や対面でのセッション（オフセ）でも幅広く利用できます。

&2 利用規約
&em_禁止事項 は以下の3つです。必ずご確認ください。
&br
- 自作発言
...
&br
なお下2つに関しては相談いただければ許可する場合もございます。
...
ぜひ使ってください。
&button_${$templateText.baseUrl}/material/quest_empty1.png 未記入画像（PNG、「その他」記載なし）はこちら
