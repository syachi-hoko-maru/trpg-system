...
&br
このページではそんな流行のTRPGについて、 &em_TRPG初心者 の方や、「TRPGって聞いたことあるけどなんだかわからない……」 という方、「TRPGをやってみたいけどよくわからない……」という方向けに、 &em_「TRPGとは何か」から、「TRPGの魅力」や「TRPGの始め方」までを解説する ページとなっています。
&br
また、TRPG経験者の方にも「TRPGって何？」「TRPGやりたいんだけど」と &em_質問された際に役立つ ページになっていると思うので、1回読んでいただければ幸いです。
...
もしくはTCGに「ポケモンカード」「遊戯王」「デュエル・マスターズ」がある感覚です。
&br
また、デジタルゲームに「ポケットモンスター」シリーズがあって、「ポケットモンスタースカーレット」以外にも「ポケットモンスターソード」や「ポケットモンスターブリリアントダイヤモンド」がありますが、 &em_TRPGにもシリーズのようなものがあります。 
例えば以下のようなものです。
&br
- クトゥルフ神話TRPG
...
現在、YouTubeに多く動画が投稿され、人気が高いTRPGです。
&br
...
個人的には一押しのTRPGです。
&br
ソード・ワールド2.5の魅力は以下のページで解説しているので、こちらを読んでください。
&button_/sw25
&br
