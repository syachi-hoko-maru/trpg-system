...
export const pageSettingList: PageSetting[] = (
  [
    ...
    },
    {
      ...
      osusume: true,
      explain:
        "ソード・ワールド2.5（SW2.5/ソドワ）でキャラクターとして使える種族の一覧と、その紹介をしているページです。どのルールブック・サプリメントに載っているかも掲載しています。人間・エルフ・ドワーフなど、ルールブックIIやIIIで追加されるメリア・ティエンスなど、サプリメントで追加されるアルヴ・ソレイユ・スプリガン・アビスボーン・フロウライトなども掲載しています。",
      tags: ["sw25"],
    },
    {
